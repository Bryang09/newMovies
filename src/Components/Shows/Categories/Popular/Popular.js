...
class Popular extends Component {
  ...
  onPageFour = () => {
    axios
      .get(
        `https://api.themoviedb.org/3/tv/popular?api_key=${API_KEY}&language=en-US&page=4`
      )
      .then(res => this.setState({ popular: res.data }))
      .catch(err => console.log(err));
  ...
  onPageFive = () => {
    axios
      .get(
        `https://api.themoviedb.org/3/tv/popular?api_key=${API_KEY}&language=en-US&page=5`
      )
      .then(res => this.setState({ popular: res.data }))
      .catch(err => console.log(err));
